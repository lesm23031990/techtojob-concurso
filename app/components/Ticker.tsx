...
/* D137 · Perf (TBT): each half only needs to be WIDER than the viewport, so two
   repeats of the 9 tokens (~2.5k px) already overflow the common widths; the
   third repeat was pure DOM weight on the load-time layout. */
const TICKER_REPEAT = 2;
 ...
 *
 * D96: one half holds the tokens repeated `TICKER_REPEAT` times (~2.5k px),
