...
| 3 | **Torneos (paso 2)** | **`ink`** | Sección "juego" y **prueba de que la comunidad está viva**: headline en `brand` 700 sobre oscuro (6.17 ✅) + símbolo de agua `gradient` al 10% (R15). **D71:** rejilla hairline asimétrica con 4 pilares (torneo en curso + CTA `DiscordCta size="nav"`, tiempo estático D/H/M con Sora `tabular-nums`, el botín y el salón de la fama), esquinas rectas y sin sombras; todo rotulado como maqueta (brief/J2) |
