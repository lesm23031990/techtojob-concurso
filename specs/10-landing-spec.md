...
| 3 | **Torneos** (movida del #5) | `#torneos` | Competiciones abiertas como esta: la prueba de que la comunidad está viva. **D71/D72:** cuatro pilares en rejilla hairline sobre `ink` — torneo en curso + CTA, **cierre real con tabla de husos** (`tabular-nums`, estático), el botín y el salón de la fama (estos dos, maqueta declarada) | R15 |
